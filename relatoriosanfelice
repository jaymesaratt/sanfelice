...
################################################################################
##
##  Inserir arquivos das emissões na pasta Dados
##  Alterar a data inicial conforme o mês inicial de apuração
##  Rodar o Script e abrir o Excel "Resumo_Final_Unico.xlsx"
##  Copiar três linhas(movimento do Mês) para "Planilha Cálculos Sanfelice.xlsx"
##  Conferir valores, se estão de acordo como "Resumo_Final_Unico.xlsx"
##  Enviar para Jayme por e-mail
##
################################################################################
################################################################################
...
caminho <- "J:/FINANCEIRO/CLIENTES/NBC/sanfelice/Dados"
...
setwd("J:/FINANCEIRO/CLIENTES/NBC/sanfelice")
library(openxlsx)
